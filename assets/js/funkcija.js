$(document).mousemove(function(event){
    ...
    function buildGraph(jsondata) {
        ...
        {
						document.getElementById('tdName').innerHTML = d.name;
						document.getElementById('tdEmail').innerHTML = d.email;
						document.getElementById('tdOd').innerHTML = d.od;
						document.getElementById('tdMob').innerHTML = d.mob;
						document.getElementById('tdFb').innerHTML = d.fb;			//'<a href="http://fb.com/'+d.fb+'"/>Facebook</a>'; 
						document.getElementById('tdSajt').innerHTML = d.sajt;
						document.getElementById('tdBio').innerHTML = d.bio;
						document.getElementById('tdSlika').innerHTML = '<img width="200px" src="'+d.slika+'" />'; 
        ...
        function mouseout(d)
        {
			...
			//document.getElementById('tdSlika').style.display='none';
